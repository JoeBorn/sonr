...
public class DefaultAppScreen extends Activity {
	...
	public void buttonContinue(View view) {
		...
		theclient = new SONRClient(this, SONR.findAudioRecord(), SONR.bufferSize, (AudioManager) this.getSystemService(Context.AUDIO_SERVICE));
		theclient.onCreate();
